...
savePath = '../utilities/metricFunctions/n6/';
mkdir(savePath);
...
% NL: for now, I copy RSym into mathematica and past the resulting solution
...
% toc
%%
ssVecSym = sixStateSSFromMathematica(RSymRaw);
rateSymAlt = sixStateProductionRate(RSymRaw);
