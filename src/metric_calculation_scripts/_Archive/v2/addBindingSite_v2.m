function [networkInfo, RSym] = addBindingSite_v2(networkInfoInit)
...
%     end
    ...
    RSym(ismember(transitionInfoArray,-[1,2]) & ~activity_vec_full & n_total_bound==1) = kmi;
    RSym(ismember(transitionInfoArray,-[1,2]) & ~activity_vec_full & n_total_bound==2) = kmi2;
    RSym(ismember(transitionInfoArray,-[1,2]) & activity_vec_full & n_total_bound==1) = kma;
