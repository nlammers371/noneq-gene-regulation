...
eq_max = nanmax(master_struct_multi_bs(5).sharp_right_boundary_eq);
s0_vec_5bs = master_struct_multi_bs(5).sharp_right_boundary/eq_max;

slb(1) = scatter(cw_vec,s0_vec_5bs, markerSize,'MarkerEdgeAlpha',.25,'MarkerEdgeColor','k','MarkerFaceAlpha',1,...
...
for i = 1:length(master_struct_multi_g)-1
    ...
    slb(i+1) = scatter(cw_vec,s0_vec, markerSize,'MarkerEdgeAlpha',.25,'MarkerEdgeColor','k','MarkerFaceAlpha',1,...
                      'MarkerFaceColor',cmap_pu(2*i,:));
end
eq_max = nanmax(master_struct_multi_bs(2).sharp_right_boundary_eq);
cw_vec = master_struct_multi_g2(3).cw_boundary;
s0_vec = master_struct_multi_g2(3).sharp_right_boundary/eq_max;

slb(end+1) = scatter(cw_vec,s0_vec, markerSize,'MarkerEdgeAlpha',.25,'MarkerEdgeColor','k','MarkerFaceAlpha',1,...
...
slb = [slb(2:end) slb(1)];                
legend(slb, 'N_g=2 (N_a=1)','N_g=3 (N_a=1)','N_g=4 (N_a=1)','N_g=5 (N_a=1)','N_g=4 (N_a=2)','N_g=2 (N_a=5)')
...
% slb = [slb(2:end) slb(1)];                
% legend(slb, 'N_g=2 (N_a=1)','N_g=3 (N_a=1)','N_g=4 (N_a=1)','N_g=5 (N_a=1)','N_g=4 (N_a=2)','N_g=2 (N_a=5)','Location','northwest')
xlabel('relative wrong factor concentration (c_w/c^*)');
