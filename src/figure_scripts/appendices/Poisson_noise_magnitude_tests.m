% This script uses stochastic simulations of simple 4 state gene circuit to
% test the validity of the Gaussian noise approximation used throughout
% this work
