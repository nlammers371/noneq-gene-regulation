...
% now we need to assign values to the variables
% rate_cell = {'k21', 'k34', 'k12', 'k43', 'k14', 'k23', 'k41', 'k32'};
% rate_index_pairs = [3, 6; 1, 8; 2, 4; 7, 5];
% rate_index_list = [3, 6; 1, 8; 2, 4; 7, 5]';
% rate_index_list = rate_index_list(:);

% for r = 1:length(rate_cell)
%     eval([rate_cell{r} ' = rightRates(:,rate_index_list(r));' ]);
% end
