...
writePath = [DropboxFolder filesep 'sweeps05_info_vs_cw_hm_v2' filesep];
mkdir(writePath);
...
% set sim options
sweep_options = {'n_sim',100,'n_seeds',25,'n_iters_max',50, 'numerical_precision',10, 'useParpool',1,'ds_factor',10};
    ...
    for m = [1 4]
        ...
        for n = bs_list
            ...
            [sim_info, sim_results, sim_results_short] = ...
                                ...
                                'equilibrium_flag',equilibrium_flag,'TauCycleTime',1,'half_max_flag',hm_flag,...
