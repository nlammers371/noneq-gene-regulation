...
[sim_info_as, sim_struct_as] = param_sweep_multi_v2([phi_index ir_index],functionPath, sweep_options{:},...
                                          'half_max_flag',false,'equilibrium_flag',false,'simType','all_specific');
                                        
[sim_info_1s, sim_struct_1s] = param_sweep_multi_v2([phi_index ir_index],functionPath, sweep_options{:},...
                                          'half_max_flag',false,'equilibrium_flag',false,'cw',1);                                        
toc;                                        
...
%%
[sim_info_1s, sim_struct_1s] = param_sweep_multi_v2([phi_index ir_index],functionPath, sweep_options{:},...
                                          'half_max_flag',false,'equilibrium_flag',false,'simType','PIC');
%% %%%%%%%%%%%%%%%% info rate vs energy flux per cycle %%%%%%%%%%%%%%%%%%%%
tic
[sim_info_eq, sim_struct_eq] = param_sweep_multi_v2([cw_index ir_index],functionPath, sweep_options{:},...
                                          'half_max_flag',false,'equilibrium_flag',true);
                                        
[sim_info_neq, sim_struct_neq] = param_sweep_multi_v2([cw_index ir_index],functionPath, sweep_options{:},...
                                          'half_max_flag',false,'equilibrium_flag',false);                                        
