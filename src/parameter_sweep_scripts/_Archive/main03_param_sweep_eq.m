...
% specify paths
addpath('../utilities')
outPath = '../../out/parameter_sweep_eq/';
mkdir(outPath)
...
%         new_rate_vec = sample_rates_general(rate_vec_init, rate_bounds);
        ...
        for n = 2:n_iters                  
            ...
            diff_array = metric_array_eq(bound_points,metric_indices,mci) - prev_point;
            ...
            prev_point = metric_array_eq(mt_index,metric_indices,mci);                       
    ...
    simulation_results(mdi).metric_array_noneq = metric_array_eq;        
