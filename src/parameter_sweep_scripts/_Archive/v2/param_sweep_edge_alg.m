...
m_space = [1 3; 2 4; 3 1; 4 2];
% specify sampling hyperparameters
model_spec_vec = [1:4]; % 5 corresponds to Hopfield/Ninio architecture
...
for mdi = 1:numel(model_spec_vec)
    ...
    for mci = 1:n_mcmc
        ...
        metric_vec = calculatePerformanceMetrics(delta_mu_in,spec_edges,rate_vec_init(1:4),rate_vec_init(5:8),delta_mu_in);        
        ...
        for k = 1:n_seeds
            ...
            metric_vec = calculatePerformanceMetrics(delta_mu_in,spec_edges, rate_array(1+k,1:4), rate_array(1+k,5:8),delta_mu_in);      
        ...
        for n = 2:n_iters               
            ...
            for k = 1:n_seeds
                ...
                metric_vec = calculatePerformanceMetrics(delta_mu_in,spec_edges, rate_array(ind,1:4), rate_array(ind,5:8),delta_mu_in);                                   
